 ...
 */
public class UnblockCardDialog extends DialogFragment implements DialogInterface.OnClickListener  {

	public static final String LOG_TAG = UnblockCardDialog.class.getName();

	private BankSelector bankSelector;
	private Handler handler;

	private String cardName = "Кредит";
	private String bankName = "Аваль";

	public UnblockCardDialog(String cardName, String bankName) {
	...
	public Dialog onCreateDialog(Bundle savedInstanceState) {
		...
		dialog.setTitle("Разблокирование карты");
		dialog.setMessage("Вы действительно хотите раззаблокировать карту " + cardName + "(" + bankName + ")");
...
//				DBWork.addToHistory(AtributesBean.getInstance().getIdCard(), "unblocking card");

				mainActivity.msgUnblockCard(true, cardName, bankName);
				break;
			case Dialog.BUTTON_NEGATIVE:
				mainActivity.msgUnblockCard(false, "---", "---");
				break;
		}
	}
}
